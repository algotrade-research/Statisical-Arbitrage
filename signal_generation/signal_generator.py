...
def calculate_positions(
    ...
    Args:
        ...
        first_allocation (float, optional): Initial allocation percentage. Defaults to 0.4.
        adding_allocation (float, optional): Incremental allocation percentage. Defaults to 0.15.
    ...
    columns = (
        ["Total_Port_Trading", "VN30F1M_Position"]
    ...
    for date in dates:
        ...
        if num_active == 0:
            ...
            base_allocation = min(
                first_allocation + adding_allocation * (num_active - 1), max_allocation
            )
